...
// Inngest function to save workspace function to a database
...
const syncWorkspaceUpate = inngest.createFunction(
  ...
  async ({ event, step }) => {
    ...
    await sendEmail({
      ...
      body: `<div style="max-width: 600px;">
            ...
            <a href="${origin}" style="background-colour: #007bff; padding: 12px 24px; border-radius: 5px; color: #fff; font-weight: 600; font-size: 16px; text-decoration: none;">
                View Task
            </a>
